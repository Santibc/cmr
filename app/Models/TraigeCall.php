...
class TraigeCall extends Model
{
    use HasFactory;
    ...
    {
        return $this->belongsTo(TraigeCall::class, 'parent_call_id');
    }

    public function childCalls()
    {
        return $this->hasMany(TraigeCall::class, 'parent_call_id');
    }

    public function logs()
    {
        return $this->hasMany(Log::class, 'id_tabla')->where('tabla', 'traige_calls')->latest();
    }
}
