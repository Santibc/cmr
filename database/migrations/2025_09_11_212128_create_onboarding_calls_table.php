...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('onboarding_calls', function (Blueprint $table) {
            ...
            $table->foreignId('user_id')->constrained('users')->onDelete('cascade'); // CMS user
            $table->foreignId('parent_call_id')->nullable()->constrained('onboarding_calls')->onDelete('set null'); // Para reprogramaciones
